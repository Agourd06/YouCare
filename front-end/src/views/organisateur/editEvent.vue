...
export default {
    ...
    methods: {
        ...
        getEventData(eventId) {
            ...
            axios.get(`http://127.0.0.1:8000/api/editEvent/${eventId}`, config)
                .then(response => {
                    this.events.title = response.data.event.title
                    this.events.type = response.data.event.type
                    this.events.date = response.data.event.date
                    this.events.localisation = response.data.event.localisation
                    this.events.competence = response.data.event.competence
                    this.events.description = response.data.event.description
                })
        },
